        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <!-- Chirp's 'Edited' message on updated chirps -->
                ...
                <Dropdown v-if="chirp.user.id === $page.props.auth.user.id">
                    ...
                    <!-- Edit button -->
                    <template #content>
                        <button @click="editing = true" class="block w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:bg-gray-100 transition duration-150 ease-in-out" >
                            Edit
                        </button>
                    </template>
                </Dropdown>
            ...
            <form v-if="editing" @submit.prevent="form.put(route('chirps.update', chirp.id), { onSuccess: () => editing = false })">
                ...
                <!-- Chirp's message in editting mode -->
            ...
            <!-- Chirp's message in normal mode -->
